 ...
 *
 */
export const getSearchFilterLiveProducts = <ThrowOnError extends boolean = false>(options: Options<GetSearchFilterLiveProductsData, ThrowOnError>): RequestResult<GetSearchFilterLiveProductsResponses, GetSearchFilterLiveProductsErrors, ThrowOnError> => (options.client ?? client).get<GetSearchFilterLiveProductsResponses, GetSearchFilterLiveProductsErrors, ThrowOnError>({
    security: [{
            key: 'BearerAuth',
            scheme: 'bearer',
            type: 'http'
